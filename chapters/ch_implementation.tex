...
Figure \ref{fig:fig_chirp_eff} shows the chirp efficiency
...
Figure \ref{fig:fig_compare_means} shows in gray the raw data of the first 20 range scan lines
...
big part of the noise signal is statistically uncorrelated. Table \ref{tab:mean}
