...
startup\footnote{\url{https://www.crunchbase.com/organization/vayyar}} that was
...
\Cref{fig:walabot_rangetest_data} shows the signal from two Walabot antenna pairs as it
records the scene in image \cref{fig:walabot_rangetest_setup} with can stacks at \(0.5m\) \(1m\) and
