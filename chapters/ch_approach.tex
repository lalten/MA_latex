...
\begin{figure}[htp]
    ...
    \includegraphics[max height=10cm,max width=10cm]{diagrams/Radar_Reprojection_Geometry}
...
\begin{figure}[htp]
    ...
    \includegraphics[max height=10cm,max width=10cm]{diagrams/Radar_Reprojection_Geometry_forward}
