...
\cref{fig:geometry}). If the radar passes the target on the side, so that the
...
\begin{figure}[htp]
    ...
    \end{subfigure}
    \caption{\label{fig:geometry}Reprojection geometries}
\end{figure}
...
\subsection{Geometry for the General case}\label{geometry-for-the-general-case}
