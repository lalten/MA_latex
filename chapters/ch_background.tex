...
\begin{figure}[htp]
    \centering
    \includegraphics[max width=12cm]{diagrams/missed_detections}
    \caption{Radar (heatmap) has fewer missed detections than lidar (black dots), because of its wider beam with and foliage penetration capability. Adapted from \cite{Adams2015}}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        ...
        \caption{Aerial picture of the scene}
