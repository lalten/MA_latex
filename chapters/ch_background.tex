...
\begin{figure}[htp]
    ...
    \includegraphics[max height=10cm,max width=10cm]{diagrams/radar_pulsed}
...
\begin{figure}[htp]
    ...
    \includegraphics[max height=10cm,max width=10cm]{diagrams/fmcw_blocks}
...
\begin{figure}[htp]
    \centering
    \label{fig:radar_fmcw_2_stationary}
    \includegraphics[max height=10cm,max width=10cm]{diagrams/radar_fmcw_2_stationary}
...
In the top subplot, figure \ref{fig:radar_fmcw_2_stationary} shows the transmitted frequency sweep
...
\begin{figure}[htp]
    \centering
    \label{fig:radar_fmcw_2}
    \includegraphics[max height=10cm,max width=10cm]{diagrams/radar_fmcw_2}
...
\begin{figure}[htp]
    \centering
    \label{fig:radar_fmcw_multitarget}
    \includegraphics[max height=10cm,max width=10cm]{diagrams/radar_fmcw_multitarget}
    \caption{Each target contributes a frequency corresponding to its range in the beat spectrum.}
\end{figure}

Figure \ref{fig:radar_fmcw_multitarget} shows a real-world example of how the beat signal \(f_b\)
...
\begin{figure}[htp]
    \centering
    \label{fig:doa}
    \includegraphics[max height=10cm,max width=10cm]{diagrams/Direction_of_Arrival}
